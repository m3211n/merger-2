...
namespace myTiles {
    ...
    helpers._registerFactory("tilemap", function(name: string) {
        switch(helpers.stringTrim(name)) {
            case "level1":
            case "level1":return tiles.createTilemap(hex`0a0008000102020202020202020305000000000000000004050000000000000000040500000000000000000405000000000000000004050000000000000000040500000000000000000408060606060606060607`, img`
2 2 2 2 2 2 2 2 2 2 
2 . . . . . . . . 2 
2 . . . . . . . . 2 
2 . . . . . . . . 2 
